<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        // busca o valor inserido no inpust
        ...
        if(!$erro){
            ...
            $gestor->EXE_NON_QUERY(
                'UPDATE utilizadores SET email = :email, atualizado_em = :atualizado_em 
            ...
            <form action="?a=perfil_alterar_email" method="post">
                <div classe="col-sm-4 offset-sm-4 justify-content-center">
                    <div class="form-group">
                        <label for="text_nono_email">Novo email:</label>
                        <input type="email" 
                               class="form-control" 
                               name="text_novo_email"
                               required title="No mínimo 5 caracteres e no máximo 50."
                               pattern=".{5,50}">
                    </div>                   
                </div>
